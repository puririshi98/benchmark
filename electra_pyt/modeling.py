...
class ElectraForQuestionAnsweringSimple(ElectraPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(self, hidden_states, start_states=None, start_positions=None, cls_index=None):
        ...
        Args:
            ...
            **cls_index**: torch.LongTensor of shape ``(batch_size,)``
                position of the CLS token. If None, take the last token. (changed to first token)
    ...
    def forward(
        ...
        if start_positions is not None and end_positions is not None:
            ...
            start_top_log_probs, start_top_index = torch.topk(
                start_log_probs, start_n_top, dim=-1
            ...
            end_top_log_probs, end_top_index = torch.topk(
                end_log_probs, end_n_top, dim=1
            )  # shape (bsz, end_n_top, start_n_top)
            end_top_log_probs = end_top_log_probs.transpose(1, 2).reshape(-1, start_n_top * end_n_top)
            end_top_index = end_top_index.transpose(1, 2).reshape(-1, start_n_top * end_n_top)
            ...
            cls_logits = self.answer_class(
                hidden_states, start_states=start_states, cls_index=None
